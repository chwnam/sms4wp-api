...
[관리자 전용 API](#관리자-전용-api)
  - [관리자의 사용자 관리](#관리자의-사용자-관리)
    - 멤버 등록
    - 멤버 조회
    - 멤버 수정
    - 멤버 삭제
  - [관리자의 인증 토큰 관리](#관리자의-인증-토큰-관리)
    - 토큰 조회
    - 토큰 삭제
    - 토큰 발급
    - 토큰 회수
  - [관리자의 메시지 시그니쳐 관리](#관리자의-메시지-시그니쳐-관리)
    - 시그니쳐 생성
    - 시그니쳐 수정
    - 시그니쳐 조회
    - 시그니쳐 삭제
  - [관리자의 포인트 관리](#관리자의-포인트-관리)
    - 포인트 조회
    - 포인트 조정
  - [관리자의 메시지 내역 조회](#관리자의-메시지-내역-조회)
    - 내역 조회
  - [관리자의 포인트 증감 내역 조회](#관리자의-포인트-증감-내역-조회)
    - 포인트 증감 내역
  - [관리자의 시스템 체크](#관리자의-시스템-체크)
    - 분산처리 서버 체크
    - 데이터베이스 및 시스템 버전 체크
...
### 전화번호 표기 및 저장
API를 통해 전화번호를 입력할 때에는 단순히 0~9까지 숫자의 연속으로 지정할 수도 있고 일정 구간 '-' 문자로 구분을 지어 입력해도 무방합니다. 단 구분해여 전화번호를 지정하는 경우 숫자 길이 {3}-{3 or 4}-{4} 형태를 유지해 주십시오.
