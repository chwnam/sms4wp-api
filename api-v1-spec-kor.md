...
* SMS/LMS 전송 요청 파라미터
  * SMS와 LMS는 전송 파라미터가 동일합니다. 단, LMS가 보다 많은 내용의 메시지를 보낼 수 있습니다.
    * 단보 전송: 수신자가 한 명인 경우입니다.
    * 동보 전송: 같은 내용을 복수의 수신자에게 전달하는 경우를 말합니다.
    ...
    * 벌크 전송: 엑셀 파일을 이용해 여러 명에게 각각 다른 내용의 메시지를 전송할 때 사용합니다.
      * 요청 파라미터:
        * bulk_file:
        * bulk_file 파라미터가 있는 경우 우선적으로 인식됩니다. 또한 이 파라미터가 선언될 경우 다른 파라미터는 무시됩니다.
